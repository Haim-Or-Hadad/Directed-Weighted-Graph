...
1. Clone the project.
2. Go to main.py
3. write your the commands you wish in the check function. (There are 4 examples (check0-3) of available commands in the graph.

<b>plot_graph fucntion will run a gui that allow you the following options:<b>
### save
